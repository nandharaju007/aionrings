// Country → international dial code (E.164, no leading '+')
export const DIAL_CODES: Record<string, string> = {
  "Afghanistan":"93","Albania":"355","Algeria":"213","Andorra":"376","Angola":"244","Antigua and Barbuda":"1268",
  "Argentina":"54","Armenia":"374","Australia":"61","Austria":"43","Azerbaijan":"994","Bahamas":"1242","Bahrain":"973",
  "Bangladesh":"880","Barbados":"1246","Belarus":"375","Belgium":"32","Belize":"501","Benin":"229","Bhutan":"975",
  "Bolivia":"591","Bosnia and Herzegovina":"387","Botswana":"267","Brazil":"55","Brunei":"673","Bulgaria":"359",
  "Burkina Faso":"226","Burundi":"257","Cabo Verde":"238","Cambodia":"855","Cameroon":"237","Canada":"1",
  "Central African Republic":"236","Chad":"235","Chile":"56","China":"86","Colombia":"57","Comoros":"269",
  "Congo (Brazzaville)":"242","Congo (Kinshasa)":"243","Costa Rica":"506","Côte d'Ivoire":"225","Croatia":"385",
  "Cuba":"53","Cyprus":"357","Czechia":"420","Denmark":"45","Djibouti":"253","Dominica":"1767","Dominican Republic":"1809",
  "Ecuador":"593","Egypt":"20","El Salvador":"503","Equatorial Guinea":"240","Eritrea":"291","Estonia":"372",
  "Eswatini":"268","Ethiopia":"251","Fiji":"679","Finland":"358","France":"33","Gabon":"241","Gambia":"220",
  "Georgia":"995","Germany":"49","Ghana":"233","Greece":"30","Grenada":"1473","Guatemala":"502","Guinea":"224",
  "Guinea-Bissau":"245","Guyana":"592","Haiti":"509","Honduras":"504","Hong Kong":"852","Hungary":"36","Iceland":"354",
  "India":"91","Indonesia":"62","Iran":"98","Iraq":"964","Ireland":"353","Israel":"972","Italy":"39","Jamaica":"1876",
  ...
  "Lithuania":"370","Luxembourg":"352","Macao":"853","Madagascar":"261","Malawi":"265","Malaysia":"60","Maldives":"960",
  ...
  "Mozambique":"258","Myanmar":"95","Namibia":"264","Nauru":"674","Nepal":"977","Netherlands":"31","New Zealand":"64",
  "Nicaragua":"505","Niger":"227","Nigeria":"234","North Macedonia":"389","Norway":"47","Oman":"968","Pakistan":"92",
  ...
  "Seychelles":"248","Sierra Leone":"232","Singapore":"65","Slovakia":"421","Slovenia":"386","Solomon Islands":"677",
  ...
  "Tanzania":"255","Thailand":"66","Timor-Leste":"670","Togo":"228","Tonga":"676","Trinidad and Tobago":"1868",
...
export const DIAL_CODE_OPTIONS: Array<{ code: string; country: string }> = Object.entries(DIAL_CODES)
  .map(([country, code]) => ({ country, code }))
  .sort((a, b) => a.country.localeCompare(b.country));

// ISO alpha-2 country codes for short labels like "US +1", "IN +91"
...
// Options for the phone country-code dropdown, e.g. { iso: "US", code: "1", country: "United States" }
export const PHONE_CODE_OPTIONS: Array<{ iso: string; code: string; country: string }> = Object.entries(DIAL_CODES)
  .map(([country, code]) => ({ country, code, iso: COUNTRY_ISO2[country] || "" }))
  .filter((o) => o.iso)
  .sort((a, b) => a.country.localeCompare(b.country));
