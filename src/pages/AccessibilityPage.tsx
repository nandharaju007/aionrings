        ...
        <div className="container mx-auto px-6 lg:px-12 max-w-4xl">
          ...
          >
            ...
            <div className="space-y-10 text-ink-soft leading-relaxed">
              <section>
                <h2 className="text-xl font-light text-ink mb-4 border-b border-border/50 pb-2">Our Commitment</h2>
                <p>
              ...
              <section>
                <h2 className="text-xl font-light text-ink mb-4 border-b border-border/50 pb-2">Conformance Status</h2>
                <p>
              ...
              <section>
                <h2 className="text-xl font-light text-ink mb-4 border-b border-border/50 pb-2">Accessibility Features</h2>
              ...
              <section>
                <h2 className="text-xl font-light text-ink mb-4 border-b border-border/50 pb-2">Feedback</h2>
                <p>
