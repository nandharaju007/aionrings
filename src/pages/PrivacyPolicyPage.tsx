        ...
        <div className="container mx-auto px-6 lg:px-12 max-w-4xl">
          ...
          >
            ...
            <div className="space-y-10 text-ink-soft leading-relaxed">
              <section>
                <h2 className="text-xl font-light text-ink mb-4 border-b border-border/50 pb-2">1. Introduction</h2>
                <p>
              ...
              <section>
                <h2 className="text-xl font-light text-ink mb-4 border-b border-border/50 pb-2">2. Information We Collect</h2>
                
                <h3 className="text-lg font-light text-ink/90 mb-2 mt-6">2.1 Biometric & Physiological Signals</h3>
                ...
                <h3 className="text-lg font-light text-ink/90 mb-2 mt-6">2.2 Personal Information</h3>
                <ul className="list-disc list-inside space-y-1 ml-4">
                ...
                <h3 className="text-lg font-light text-ink/90 mb-2 mt-6">2.3 Device & Usage Data</h3>
                <ul className="list-disc list-inside space-y-1 ml-4">
                ...
                <h3 className="text-lg font-light text-ink/90 mb-2 mt-6">2.4 Location Data</h3>
                <ul className="list-disc list-inside space-y-1 ml-4">
              ...
              <section>
                <h2 className="text-xl font-light text-ink mb-4 border-b border-border/50 pb-2">3. How We Use Your Information</h2>
              ...
              <section>
                <h2 className="text-xl font-light text-ink mb-4 border-b border-border/50 pb-2">4. Data Storage & Security</h2>
                <p className="mb-4">
                  aiOn follows a <strong className="text-ink">local-first architecture</strong>. By default, your 
              ...
              <section>
                <h2 className="text-xl font-light text-ink mb-4 border-b border-border/50 pb-2">5. Data Sharing & Third Parties</h2>
                <p className="mb-4">We do not sell your personal or biometric data. We may share data only in the following circumstances:</p>
                <ul className="list-disc list-inside space-y-2 ml-4">
                  <li><strong className="text-ink">Healthcare Providers:</strong> Only with your explicit, revocable consent through the provider dashboard integration</li>
                  <li><strong className="text-ink">Service Providers:</strong> Trusted partners who assist in operating our platform (bound by strict confidentiality agreements)</li>
                  <li><strong className="text-ink">Legal Requirements:</strong> When required by applicable law, regulation, or legal process</li>
                  <li><strong className="text-ink">Anonymized Data:</strong> Aggregated, de-identified data for research and product improvement</li>
                </ul>
              </section>

              <section>
                <h2 className="text-xl font-light text-ink mb-4 border-b border-border/50 pb-2">6. Your Rights & Controls</h2>
                <ul className="list-disc list-inside space-y-2 ml-4">
                  <li><strong className="text-ink">Access:</strong> Request a copy of all data we hold about you</li>
                  <li><strong className="text-ink">Deletion:</strong> Request complete deletion of your data from our systems</li>
                  <li><strong className="text-ink">Portability:</strong> Export your data in a standard, machine-readable format</li>
                  <li><strong className="text-ink">Correction:</strong> Update or correct any inaccurate personal information</li>
                  <li><strong className="text-ink">Withdrawal:</strong> Revoke consent for data processing at any time</li>
                  <li><strong className="text-ink">Opt-Out:</strong> Disable cloud sync, location tracking, or marketing communications</li>
                </ul>
              </section>

              <section>
                <h2 className="text-xl font-light text-ink mb-4 border-b border-border/50 pb-2">7. Data Retention</h2>
                <p>
              ...
              <section>
                <h2 className="text-xl font-light text-ink mb-4 border-b border-border/50 pb-2">8. Children's Privacy</h2>
                <p>
              ...
              <section>
                <h2 className="text-xl font-light text-ink mb-4 border-b border-border/50 pb-2">9. Changes to This Policy</h2>
                <p>
              ...
              <section>
                <h2 className="text-xl font-light text-ink mb-4 border-b border-border/50 pb-2">10. Contact Us</h2>
                <p>
