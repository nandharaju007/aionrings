          ...
          {done ? (
            ...
            <>
              ...
              <div className="rounded-3xl border border-white/[0.08] bg-gradient-to-b from-white/[0.03] to-transparent p-10 md:p-16 text-center">
                ...
                <a href="mailto:contact@aionrings.com" className="inline-flex items-center gap-2 rounded-full px-8 py-4 text-[15px] font-semibold text-white hover:brightness-110 transition-all" style={{ background: GRADIENT }}>
