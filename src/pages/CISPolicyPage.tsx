        ...
        <div className="container mx-auto px-6 lg:px-12 max-w-4xl">
          ...
          >
            ...
            <div className="space-y-10 text-ink-soft leading-relaxed">
              <section>
                <h2 className="text-xl font-light text-ink mb-4 border-b border-border/50 pb-2">1. Overview</h2>
                <p>
              ...
              <section>
                <h2 className="text-xl font-light text-ink mb-4 border-b border-border/50 pb-2">2. Scope</h2>
              ...
              <section>
                <h2 className="text-xl font-light text-ink mb-4 border-b border-border/50 pb-2">3. CIS Control Domains</h2>
                <p className="mb-8">
                ...
                <div className="space-y-6">
                  {controlDomains.map((domain) => (
                    <div key={domain.title} className="surface-card p-6">
                      <div className="flex items-center gap-3 mb-4">
                        <div className="w-10 h-10 rounded-full bg-primary/10 flex items-center justify-center text-primary">
                          {domain.icon}
                        </div>
                        <h3 className="text-lg font-light text-ink">{domain.title}</h3>
                      </div>
              ...
              <section>
                <h2 className="text-xl font-light text-ink mb-4 border-b border-border/50 pb-2">4. Secure Development Practices</h2>
              ...
              <section>
                <h2 className="text-xl font-light text-ink mb-4 border-b border-border/50 pb-2">5. Third-Party Risk Management</h2>
                <ul className="list-disc list-inside space-y-2 ml-4">
              ...
              <section>
                <h2 className="text-xl font-light text-ink mb-4 border-b border-border/50 pb-2">6. Employee Security</h2>
                <ul className="list-disc list-inside space-y-2 ml-4">
              ...
              <section>
                <h2 className="text-xl font-light text-ink mb-4 border-b border-border/50 pb-2">7. Compliance & Auditing</h2>
                <ul className="list-disc list-inside space-y-2 ml-4">
              ...
              <section>
                <h2 className="text-xl font-light text-ink mb-4 border-b border-border/50 pb-2">8. Policy Review</h2>
                <p>
              ...
              <section>
                <h2 className="text-xl font-light text-ink mb-4 border-b border-border/50 pb-2">9. Contact</h2>
                <p>
